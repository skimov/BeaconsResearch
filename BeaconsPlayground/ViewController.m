...
#define GIMBAL_PROXIMITY_UUID           [[NSUUID alloc] initWithUUIDString:@"11111111-1111-1111-1111-111111111111"]
...
//    self.region = [[ESTBeaconRegion alloc] initWithProximityUUID:GIMBAL_PROXIMITY_UUID identifier:@"GimbalSampleRegion"];
    /*
